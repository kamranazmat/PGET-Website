	...
	<body>
		<div class="container">
			...
			<fieldset class="scheduler-border">
              ...
              <div class="col-md-6">
              	<div class="col-md-3">
              		<img class="img-rounded" width="150" height="200" src="<?php echo "../images/photo/".$pdata['u_id'].".jpg"; ?>"/></br>
              		<img class="img-rounded" width="150" height="50" src="<?php echo "../images/signature/".$pdata['u_id'].".jpg"; ?>"/></br> 
              ...
              <div class="col-md-6">
				...
				<table class="table table-striped table-bordered">
				  <tr>
				    <td>Challan Identification Number</td>
