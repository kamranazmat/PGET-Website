<?php 
	...
	$con = mysqli_connect('localhost', $user, $password, 'counsellor') OR die('Error: '.mysqli_connect_error());
	$admin = mysqli_connect('localhost', $user, $password, 'admin') OR die('Error: '.mysqli_connect_error());
